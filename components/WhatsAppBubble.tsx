...
const WhatsAppBubble: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip on hover */}
      <span className="absolute right-20 bg-white text-gray-800 text-sm font-medium px-4 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
        Chat dengan kami
      </span>
