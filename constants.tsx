...
export const PROGRAMS = [
  { title: 'Tahfidz 30 Juz', description: "Program hafalan terstruktur dengan muroja'ah harian dan evaluasi berkala." },
  { title: 'Kajian Al-Qur’an dan Hadis', description: "Pendalaman tafsir, ulumul Qur'an, dan pemahaman hadis pilihan." },
  { title: 'Kajian Kehidupan Islami', description: 'Fiqh ibadah, akhlak, dan adab keseharian santri.' },
  { title: 'Bahasa Arab & Inggris', description: 'Pembiasaan percakapan dan grammar praktis untuk santri.' },
  { title: 'Seminar Keagamaan & Sains', description: 'Wawasan keilmuan terpadu untuk menumbuhkan rasa ingin tahu.' },
  { title: 'Karya Tulis & Lomba Penelitian', description: 'Melatih berpikir kritis dan komunikasi ilmiah.' },
];
...
export const TESTIMONIALS = [
  { quote: 'Anak saya berubah total di Albanna, jadi lebih mandiri dan rajin ibadah.', author: 'Orang Tua Santri' },
  { quote: 'Setelah lulus, saya diterima di Universitas Negeri dan hafal 30 juz.', author: 'Alumni SMA Albanna' },
];
